...
const PoliticasDePrivacidad = () => {
  const correoElectronico = "correo@electronico.com";
  ...
  return (
    <Fragment>
      ...
      <section className="container legales">
        ...
        <p>
          <strong>Responsable de los datos personales: </strong>Alejandro
          Agustin Diaz Garro, DNI 35838136, con domicilio en Mendoza, Ciudad,
          Argentina, en lo adelante EL GESTOR DEL SITIO WEB, y cuyo correo
          electrónico de contacto es {correoElectronico} de atencion al cliente.
        </p>
        <p>
          <strong>
        ...
        <p>
          ...
          materia, escribiendo al {correoElectronico}. <br />
        ...
        <article>
          ...
          <p>
            ...
            escribiendo al {correoElectronico}.
          </p>
        </article>
      </section>
    </Fragment>
