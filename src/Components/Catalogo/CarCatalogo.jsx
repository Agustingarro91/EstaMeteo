...
const CardCatalogo = () => {
    ...
    return(
      ...
      <img
        ...
        src="https://m.media-amazon.com/images/I/41UYNi11UPL._SL160_.jpg"
        alt=""
      />
      <div className="product-content">
        <a
          href="https://www.amazon.es/dp/B09V1CHQ4K?tag=barbacoas0f-21&linkCode=osi&th=1&psc=1&keywords=barbacoas%20de%20carbon"
          target="_blanck"
          rel="nofolow noopener sponsored"
        >
          Nombre del producto
        </a>

        <a
          href="https://www.amazon.es/gp/prime/?tag=barbacoas0f-21"
          title="Amazon Prime"
      ...
      <div className="product-footer">
        <span className="line">precio tachado</span>
